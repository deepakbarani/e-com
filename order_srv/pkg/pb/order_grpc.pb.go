...
const (
	...
	OrderService_GetByIDOrder_FullMethodName = "/order.OrderService/GetByIDOrder"
)
...
func (UnimplementedOrderServiceServer) GetByIDOrder(context.Context, *GetByIDOrderRequest) (*GetByIDOrderResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetByIDOrder not implemented")
}
